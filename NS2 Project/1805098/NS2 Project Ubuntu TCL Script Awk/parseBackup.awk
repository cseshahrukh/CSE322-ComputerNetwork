...
END {
    ...
    print dim,",", nodes,",", flows,",", packet_per_sec,",", speed, ",", sent_packets,",", dropped_packets,",", received_packets,",",(received_bytes * 8) / simulation_time,",", (total_delay / received_packets),",", (received_packets / sent_packets), ",", (dropped_packets / sent_packets), ",", total_energy_consumption;
}